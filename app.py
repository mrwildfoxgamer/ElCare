...
<div class="container">
    ...
    <div class="top-grid">
        ...
        <div class="card">
            ...
            <div class="log-box" id="alerts-container">
                <div style="padding:10px; color:#666; text-align:center;">No alerts recorded yet.</div>
            </div>
        </div>
    </div>
    ...
    <div class="sos-section">
        <div class="sos-btn-container">
            ...
            <div style="margin-top: 15px; font-weight: bold; color: #e74c3c; font-size: 1.1em;">EMERGENCY</div>
        </div>
        
        <div class="contacts-area">
            <h3 style="margin-top: 0; color: #e74c3c;">Emergency Contacts</h3>
            ...
            <p style="font-size: 0.85em; color: #888; margin-top: 10px;">Adding numbers here will include them in the SOS dialing sequence.</p>
        </div>
    </div>
        ...
        <div class="controls-grid">
            ...
            <div class="control-card">
                ...
                <div style="margin-bottom: 15px;">
                    <span id="status-sim" class="status-dot"></span> 
                    <span id="text-sim">Stopped</span>
                </div>
            ...
            <div class="control-card">
                ...
                <div style="margin-bottom: 15px;">
                    <span id="status-monitor" class="status-dot"></span> 
                    <span id="text-monitor">Stopped</span>
                </div>
            ...
            <div class="control-card">
                ...
                <p style="font-size: 0.85em; color: #888; margin: 10px 0;">Seq: Stop Sim &rarr; Run Ano &rarr; Resume Sim</p>
                <button class="ctrl-btn btn-yellow" onclick="triggerSequence()">RUN SEQUENCE</button>
            </div>

            <div class="control-card">
                <h4>Force Emergency</h4>
                <p style="font-size: 0.85em; color: #888; margin: 10px 0;">Seq: Stop Sim &rarr; Run Conf_Em &rarr; Resume Sim</p>
...
<div id="sos-overlay">
    ...
    <button onclick="stopSOS()" style="margin-top: 30px; padding: 12px 35px; background: #555; border: 1px solid white; color: white; border-radius: 5px; cursor: pointer; font-size: 16px; font-weight: bold;">CANCEL</button>
</div>
...
<script>
    ...
    function renderContacts() {
        ...
        contacts.forEach((num, index) => {
            ...
            li.innerHTML = '<span>&#x1F4DE; ' + num + '</span> <span class="remove-contact" onclick="removeContact(' + index + ')">&#x2715;</span>';
            ul.appendChild(li);
        });
    }
        ...
        fetch('/api/data')
            ...
            .then(function(data) {
                ...
                if (data.recent_alerts.length !== lastAlertCount) {
                    ...
                    data.recent_alerts.forEach(function(entry) {
